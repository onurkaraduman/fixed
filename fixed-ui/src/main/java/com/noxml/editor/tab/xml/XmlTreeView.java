...
import com.noxml.editor.handler.XmlEventHandler;
...
public class XmlTreeView extends TreeView {
    ...
    private void init() {
        ...
        setCellFactory(param -> {
            XmlTreeCell xmlTreeCell = new XmlTreeCell();
            xmlTreeCell.addClickHandler(clickHandler);
            xmlTreeCell.addAddHandler(addHandler);
            xmlTreeCell.addSearchHandler(searchHandler);
            xmlTreeCell.addRemoveHandler(removeHandler);
            return xmlTreeCell;
        });
    }
